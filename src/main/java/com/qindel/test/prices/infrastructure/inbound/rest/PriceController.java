...
import static com.qindel.test.prices.domain.vo.DateTimeFormats.PRICE_DATE_EXAMPLE;
import static com.qindel.test.prices.domain.vo.DateTimeFormats.PRICE_DATE_PATTERN;
import static com.qindel.test.prices.domain.vo.DateTimeFormats.PRICE_DATE_REGEX;
...
public class PriceController {
    ...
    public ResponseEntity<ApplicablePriceDTO> findApplicablePrice(
            ...
            @Parameter(description = "Application date in format yyyy-MM-dd'T'HH:mm:ss.SSS",
                    example = PRICE_DATE_EXAMPLE,
                    schema = @Schema(type = "string", pattern = PRICE_DATE_REGEX,
                            example = PRICE_DATE_EXAMPLE))
            @RequestParam @DateTimeFormat(pattern = PRICE_DATE_PATTERN) LocalDateTime applicationDate)
